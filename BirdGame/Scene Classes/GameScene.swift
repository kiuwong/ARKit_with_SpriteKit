...
class GameScene: SKScene {
    ...
    @objc func spwanBird() {
        ...
        if let currentFrame = sceneView.session.currentFrame {
            ...
            translation.columns.3.x = randomPosition(lowerBound: -1.5, upperBound: 1.5) //-1.5 1.5
            translation.columns.3.y = randomPosition(lowerBound: -1.5, upperBound: 1.5) //-1.5 1.5
            translation.columns.3.z = randomPosition(lowerBound: -2.0, upperBound: 2.0) //-2.0 2.0
